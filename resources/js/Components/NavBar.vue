<template>
    <header class="fixed mt-2 w-full px-4 lg:px-6 py-2 z-50">
        <nav
            class="flex h-12 justify-between items-center mx-auto dark:bg-white/30 backdrop-blur-md rounded-xl max-w-screen-xl px-5 py-1"
        >
